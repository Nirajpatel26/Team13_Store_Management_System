...
BEGIN
  ...
  APP_ADMIN.INSERT_EMPLOYEE(2, 'Priya', 'Sharma', 'priya.sharma@example.com', 9876543211, '456 Oak St, Delhi', 'Marketing Manager', TO_DATE('2022-06-01', 'YYYY-MM-DD'), 65000.00);
  APP_ADMIN.INSERT_EMPLOYEE(3, 'Amit', 'Patel', 'amit.patel@example.com', 9876543212, '789 Pine St, Bangalore', 'Inventory Manager ', TO_DATE('2022-07-01', 'YYYY-MM-DD'), 55000.00);
  ...
  APP_ADMIN.INSERT_EMPLOYEE(5, 'Vikram', 'Singh', 'vikram.singh@example.com', 9876543214, '202 Maple St, Kolkata', 'Cashier', TO_DATE('2022-09-01', 'YYYY-MM-DD'), 50000.00);
END;
/
